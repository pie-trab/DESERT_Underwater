...
int SedimDeck41DbCreatorTcl::command(int argc, const char*const* argv) {
  if ( argc == 3 ) {
    if(strcasecmp(argv[1], "setDbPathName") == 0) {
      ...
      if (debug) 
        std::cout << "SedimDeck41DbCreatorTcl::command() setDbPathName " << argv[2] << " called. error use other commands!"  << std::endl;
      ...
      if (debug) 
        std::cout << "SedimDeck41DbCreatorTcl::command() setUpDeck41CoordinatesDb " << argv[2] << " called"  << std::endl;
      ...
      if (debug) 
        std::cout << "SedimDeck41DbCreatorTcl::command() setUpDeck41MarsdenDb " << argv[2] << " called"  << std::endl;
      ...
      if (debug) 
        std::cout << "SedimDeck41DbCreatorTcl::command() setUpDeck41MarsdenOneDb " << argv[2] << " called"  << std::endl;
    ...
    if(strcasecmp(argv[1], "setDeck41DbTypeV1") == 0) {
      if (debug) 
        std::cout << "SedimDeck41DbCreatorTcl::command() setDeck41DbTypeV1 called"  << std::endl;
      ...
      if (debug) 
        std::cout << "SedimDeck41DbCreatorTcl::command() setDeck41DbTypeV2 called"  << std::endl;

#if defined (WOSS_NETCDF4_SUPPORT)
      deck41_db_type = DECK41DbType::DECK41_DB_V2_TYPE;
