...
int TransducerHandlerTcl::command( int argc, const char*const* argv ) {
  if ( argc == 4) {
    if(strcasecmp(argv[1], "importAscii") == 0) {
      ...
      if (debug) 
        std::cout << "TransducerHandlerTcl::command() importAscii called, type = " 
      ...
      if (debug) 
        std::cout << "TransducerHandlerTcl::command() importBinary called, type = " 
                  << type_name <<"; path = " << argv[3] << std::endl;
      ...
      if (debug) 
        std::cout << "TransducerHandlerTcl::command() writeValueBinary called, type = " 
                  << type_name <<"; path = " << argv[3] << std::endl;
      ...
      if (debug) 
        std::cout << "TransducerHandlerTcl::command() writeAscii called, type = " 
                  << type_name <<"; path = " << argv[3] << std::endl;
