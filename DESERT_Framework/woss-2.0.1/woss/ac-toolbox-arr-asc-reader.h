...
namespace woss {
  ...
  */
  class ArrData {
    ...
    */
    void initialize() { tx_depths.reset(); rx_depths.reset(); rx_ranges.reset(); arr_values.reset();
  ...
  */
  class ArrAscResReader : public ResReader {
    ...
    */
    ArrAscResReader( const Woss& woss );
    ...
    * @return a std::unique_ptr to valid woss::Pressure value; a not valid woss::Pressure if arr_file hasn't been read yet
    **/
    ...
    * @param rx_depth receiver depth [m]
    * @param rx_range receiver range [m]
    * @return a std::unique_ptr to valid woss::TimeArr value; a not valid woss::TimeArr if arr_file hasn't been read yet
    **/
