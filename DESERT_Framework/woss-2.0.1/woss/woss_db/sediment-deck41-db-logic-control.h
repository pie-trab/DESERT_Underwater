...
namespace woss {
  ...
  static constexpr int DECK41_FLOORTYPE_GRAVEL = 0; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_SAND = 1;  /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_SILT = 2; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_CLAY = 3; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_OOZE = 4; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_MUD = 5; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_ROCKS = 6; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_ORGANIC = 7; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_NODULES = 8; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_HARDBOTTOM = 9; /**< Value stored in NetCDF file */

  static constexpr int DECK41_FLOORTYPE_NODATA = 11; /**< Value stored in NetCDF file */
  ...
  **/
  class Deck41TypeTests {
    ...
    **/
    constexpr bool getConditionA() const { return condition_a; }
    
    /**
    * Gets condition_b bool value
    * @returns condition_b value
    **/
    constexpr bool getConditionB() const { return condition_b; }
    
    /**
    * Gets condition_c bool value
    * @returns condition_c value
    **/
    constexpr bool getConditionC() const { return condition_c; }
    
    /**
    * Gets condition_d bool value
    * @returns condition_d value
    **/
    constexpr bool getConditionD() const { return condition_d; }
    
    /**
    * Gets condition_e bool value
    * @returns condition_e value
    **/
    constexpr bool getConditionE() const { return condition_e; }
    
    /**
    * Gets condition_f bool value
    * @returns condition_f value
    **/
    constexpr bool getConditionF() const { return condition_f; }
    
    /**
    * Gets condition_g bool value
    * @returns condition_g value
    **/
    constexpr bool getConditionG() const { return condition_g; }
  ...
  //inline functions
  ///////
  inline constexpr bool Deck41TypeTests::conditionFloorA(const Deck41Types& types) const { // first = return main type
  ...
  inline constexpr bool Deck41TypeTests::conditionFloorB(const Deck41Types& types) const { // second = return secondary type
  ...
  inline constexpr bool Deck41TypeTests::conditionFloorC(const Deck41Types& types) const { // first* = try other coords, if fails get main type
  ...
  inline constexpr bool Deck41TypeTests::conditionFloorD(const Deck41Types& types) const { // second* = try other coords, if fails get secondary type
  ...
  inline constexpr bool Deck41TypeTests::conditionFloorE(const Deck41Types& types) const { // 65%/35% = weighted avg
  ...
  inline constexpr bool Deck41TypeTests::conditionFloorF(const Deck41Types& types) const { // 40%/60% = weighted avg
    bool nequal = types.first != types.second;
  ...
  inline constexpr bool Deck41TypeTests::conditionFloorG(const Deck41Types& types) const { // exit* = try other coords, if fails exit program
    return ( (types.first == DECK41_FLOORTYPE_NODATA) && (types.second == DECK41_FLOORTYPE_NODATA));
  }

  inline constexpr void Deck41TypeTests::updateAllConditions(const Deck41Types& types) {
