  ...
  **/
  class WossDbCreator {
    ...
    **/
    ...
    //WossDbCreator& operator=( WossDbCreator&& tmp ) = default;
    ...
    * @return a std::unique_ptr to a properly initialized WossDb object
    **/
    ...
    * @param woss_db reference to a recently created WossDb
