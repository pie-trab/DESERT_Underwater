...
set opt(optical_freq)       1000000             ;   # 1 MHz
set opt(optical_bw)         TODO                ;   # 100 kHz
set opt(optical_bitrate)    1000000             ;   # 1 Mbit/s
set opt(txpower)            17                  ;   # max LumaX-UV power consumption
set opt(opt_acq_db)         10              
set opt(temperatura)        293.15              ;   # in Kelvin (293.15 - 273.15 = 20 C)
set opt(txArea)             0.0028              ;   # 60mm diameter 
set opt(rxArea)             0.0028              ;   # 60mm diameter
set opt(c)                  0.043               ;   # pure seawater attenation coefficient
set opt(theta)              1.047               ;   # 60° 
